...
def main():
    """
    evaluation of snow at 0.3 mm/h (29% in CARLA)
    """
    sub_dir = 29 # TODO ANPASSEN
    dest_path = os.path.join(r"Weather_Snow/{}".format(29)) # TODO ANPASSEN
    ...
    intensity_vis.set_data_labels(["0.3 mm/h snow", "no snow"]) # TODO REGENRATE ANPASSEN
    ...
    aug_vis.set_y_ticklabel(np.arange(
        ...
        np.max(augmentation_stats_per_pcl[:, 1]) + 14, 25
    ))
    ...
    src_phys_snow = os.path.join(r"..\Datasets\BA_AdverseWeather\data\VLP16_snow_0.3.bin") # TODO REGENRATE ANPASSEN
    ...
    ed.stats_1x3_to_csv(phys_gt_distance_stats, os.path.join(r"Weather_Snow"), "clean_distance_stats_physical")
    ed.stats_1x3_to_csv(phys_gt_intensity_stats, os.path.join(r"Weather_Snow"), "clean_intensity_stats_physical")
    ...
    phys_int.set_data_labels(["0.3 mm/h snow", "no snow"])  # TODO REGENRATE ANPASSEN
