...
def main():
    """
    evaluation of fog at 3000 m (2001m in CARLA)
    """
    sub_dir = 2001 # TODO ANPASSEN
    ...
    intensity_vis.set_data_labels(["fog poor visibility [~3000 m]", "no fog"]) # TODO REGENRATE ANPASSEN
    ...
    src_phys_fog = os.path.join(r"..\Datasets\BA_AdverseWeather\data\VLP16_fog_3000.bin") # TODO REGENRATE ANPASSEN
