...
def main():
    """
    evaluation of rain at 5.0 mm/h (59% in CARLA)
    """
    sub_dir = 59 # TODO ANPASSEN
    dest_path = os.path.join(r"Weather_Rain/{}".format(59)) # TODO ANPASSEN
    ...
    intensity_vis.set_data_labels(["5.0 mm/h rain", "no rain"]) # TODO REGENRATE ANPASSEN
    ...
    src_phys_rain = os.path.join(r"..\Datasets\BA_AdverseWeather\data\VLP16_rain_5.0.bin") # TODO REGENRATE ANPASSEN
