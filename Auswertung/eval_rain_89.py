...
def main():
    """
    evaluation of rain at 91.5 mm/h (89% in CARLA)
    """
    sub_dir = 89 # TODO ANPASSEN
    dest_path = os.path.join(r"Weather_Rain/{}".format(89)) # TODO ANPASSEN
    ...
    intensity_vis.set_data_labels(["91.5 mm/h rain", "no rain"]) # TODO REGENRATE ANPASSEN
